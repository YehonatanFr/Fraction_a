...
// Addition
Fraction ariel:: operator+(float float_num, const Fraction& other) {
    return Fraction(3,4);
}
...
// Subtraction
Fraction ariel :: operator-(const Fraction& other, float float_num) {
...
bool ariel :: operator>(const Fraction& other, float float_num) {
    float tempFloat = (float)other.getNumerator() / other.getDenominator();
    return tempFloat > float_num;
}

bool ariel :: operator>(float float_num, const Fraction& other) {
    float tempFloat = (float)other.getNumerator() / other.getDenominator();
